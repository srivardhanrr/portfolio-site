      ...
      >
        ...
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/portfolio/sheltersearch.png"
              alt="Image Project"
            />
          </div>
          ...
          <div className="details">
            ...
            <a href="https://sheltersearch.in" target="_blank" className="custom-btn">
              <span>
        ...
        <SwiperSlide className="single-item swiper-slide">
          ...
          <div className="main-content">
            <img
              className="img-fluid"
              src="assets/portfolio/shivamcareer.png"
              alt="Image Project"
            />
          </div>
          {/* ITEM MAIN CONTENT ENDS */}
            ...
            <div>
              <ul>
                ...
                <li>
                  ...
                  <span>Shivam Career Consultancy</span>
                </li>
                {/* <li>
                  <span>
                    <i className="fa-regular fa-hourglass" /> Duration :
                ...
                <li>
                  ...
                  <span>Django, HTML</span>
                </li>
              </ul>
            </div>
            <a href="http://shivamcareer.in" target="_blank" className="custom-btn">
              <span>
                preview <i className="fa-solid fa-arrow-up-right-from-square" />
              </span>
            </a>
